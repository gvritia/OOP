// Реализуйте кольцевой двусвязный список с использованием структуры Node и набора функций. Реализация должна поддерживать следующие операции:
// 1. Добавление узла в конец кольцевого списка.
// 2. Удаление узла по значению.
// 3. Вывод элементов кольца
// 4. Проверка, является ли список кольцевым.
//
// Дополнительные условия
// 1.	Кольцо должно оставаться замкнутым после добавления и удаления узлов.
// 2.	Если удалён последний элемент, список должен корректно обнулиться.
