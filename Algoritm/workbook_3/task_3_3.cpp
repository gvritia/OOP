// Задача о связывании канатов.
// Дан список (массив) канатов различной длины, которые требуется связать, по два за раз, в порядке, который приведет к наименьшим затратам.
// Затраты на соединение двух канатов равны сумме их длин, а общие затраты равны сумме соединения всех канатов.
// На выходе программа должна выдать порядок связывания канатов и суммарные затраты. Решить задачу на основе использования двоичной кучи
