// Создать класс «Двоичная куча» (максимальная куча).
// Реализовать для класса: конструктор, формирующий кучу из произвольного массива, конструктор по умолчанию (создание пустой кучи).
// Для класса реализовать методы: поиск максимума, удаление максимума, добавление нового элемента в кучу.
